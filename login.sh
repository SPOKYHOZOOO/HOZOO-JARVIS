...
read -p $'\e[1;32m  Enter \033[33mNAMA \033[37mfor \033[32mLogin:\e[0m ' NAMA                
...
if [[ \$pass == $password && \$user == $NAMA ]]; then
sleep 3
clear
cd $HOME
cd TermuX-Custom
...
|SELAMAT DATANG DI BANNER JARVIS HOZOO |
|DAN JUGA TETAP SEMANGAT MAIN TERMINAL |
______________________________________|
_______________________
|BANTU SUPPORT CHANNEL |
|YOUTUBE:SPOKYHOZOO    |
|TIKTOK:SPOKYHOZOO02   |
_______________________|
