...
echo -e "\033[33m\033[1m  ANDA BELUM MENGINSTALL PKG MODULE INSTALL DULU TAR ERROR LOH." | pv -qL 10
apt update                    
apt upgrade -y 
...
echo -e "\033[31m\033[1m  LOADING PENGINSTALAN PKG MODULE \033[32m[\033[36m✓\033[32m]" | pv -qL 12
...
read -p "DI JAWAB Y SEMUA JANGAN LUPA Y(y/n): " choice
if [ "$choice" = "y" ]; then
    update_repository
fi
